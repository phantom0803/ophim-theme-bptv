                    ...
                    <div class="TPMvCn">
                        ...
                        <div class="Description">
                            ...
                            <p class="Genre AAIco-movie_creation">
                                ...
                                <i onclick="window.location.href='{{ $movie->getUrl() }}'"
                        ...
                        <div class="Cast">
                            {!! $movie->actors->map(function ($actor, $key) {
                                    if ($key < 5) {
                                        return '<img src="/themes/bptv/images/cast-image.png" alt="Diễn viên ' .
                                            $actor->name .
                                            '" title="Diễn viên ' .
                                            $actor->name .
                                            '">';
                            ...
                            <button type="button" onclick="window.location.href='{{ $movie->getUrl() }}'"
                                class="Button STPa AAIco-more_horiz"></button>
                        </div>
                        <a href="{{ $movie->getUrl() }}" class="Button TPlay AAIco-play_arrow">Xem
                            <strong>Phim</strong>
                        </a>
                    </div>
                </div>
